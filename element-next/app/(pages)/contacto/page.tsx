  ...
  return (
    <div className="ct-page">
      ...
      <div className="ct-split">
        ...
        <div className="ct-panel-l">
          <div className="ct-panel-l-inner">

            {/* Decorative background glyph */}
            <span className="ct-deco-glyph" aria-hidden="true">→</span>

            {/* Glow orbs */}
            <div className="ct-glow-a" aria-hidden="true" />
            <div className="ct-glow-b" aria-hidden="true" />

            {/* Status badge */}
            <div className="ct-status-badge" data-open={String(open)}>
            ...
            <p className="ct-subline">
              Proposta gratuita em menos de&nbsp;24h.<br />
              Sem compromisso, sem letras pequenas.
            </p>

            {/* Contact channels */}
            <div className="ct-channels" aria-label="Canais de contacto">
              <a href="mailto:info@elementgroup.pt" className="ct-channel">
                ...
                <span className="ct-channel-text">
                  ...
                  <span className="ct-channel-val">info@elementgroup.pt</span>
                </span>
                <svg className="ct-channel-arrow" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" aria-hidden="true">
                  <path d="M7 17 17 7M7 7h10v10" />
                </svg>
              </a>

              <a href="tel:+351930477894" className="ct-channel">
                <span className="ct-channel-icon" aria-hidden="true">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                ...
                <span className="ct-channel-text">
                  <span className="ct-channel-label">Telefone</span>
                  <span className="ct-channel-val">+351 930 477 894</span>
                </span>
                <svg className="ct-channel-arrow" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" aria-hidden="true">
                  <path d="M7 17 17 7M7 7h10v10" />
                </svg>
              ...
              >
                <span className="ct-channel-icon ct-channel-icon--wa" aria-hidden="true">
                ...
                <span className="ct-channel-text">
                  <span className="ct-channel-label">WhatsApp</span>
                  <span className="ct-channel-val">Mensagem direta</span>
                </span>
                <svg className="ct-channel-arrow" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" aria-hidden="true">
                  <path d="M7 17 17 7M7 7h10v10" />
                </svg>
            ...
            <div className="ct-meta">
              <div className="ct-meta-hours">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                  <circle cx="12" cy="12" r="10" />
                  <polyline points="12 6 12 12 16 14" />
                </svg>
                <span>Seg – Sex, 9h–18h</span>
                <span className="ct-meta-sep" aria-hidden="true">·</span>
                <span>Resposta em &lt;&nbsp;24h</span>
              </div>
              <div className="ct-meta-promise">
        ...
        {/* ══ RIGHT PANEL — form ════════════════════════════════════════════ */}
        <div className="ct-panel-r">
          <div className="ct-panel-r-inner">
            <ContactForm />
          </div>
        </div>
